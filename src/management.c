...
#ifdef DG
    printf("get_and_deposit_new_orders\n");
#endif
...
void deposit_finished_orders(management* m, order* o){
    //TO DO
#ifdef DG
    printf("deposit_finished_orders");
#endif
...
#ifdef DG
    printf("get_order_from_management\n");
#endif
